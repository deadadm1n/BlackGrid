...
/**
 * Server config for Aether Reach Core.
 *
...
public class Config {
    ...
    public static final ModConfigSpec.BooleanValue WELCOME_ENABLED = BUILDER
            .comment("Enable Aether Reach in-game welcome messages when players join.")
    ...
    public static final ModConfigSpec.BooleanValue LEAVE_MESSAGES_ENABLED = BUILDER
            .comment("Enable Aether Reach player leave messages.")
    ...
    public static final ModConfigSpec.BooleanValue BRIDGE_ENABLED = BUILDER
            .comment("Enable the local Watchdog <-> Aether Reach HTTP bridge.")
    ...
    public static final ModConfigSpec.IntValue BRIDGE_PORT = BUILDER
            .comment("Local bridge port used by Watchdog to talk to Aether Reach.")
