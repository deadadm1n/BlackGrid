package com.blackgrid.aetherreachcore.command;

import com.blackgrid.aetherreachcore.Config;
import com.blackgrid.aetherreachcore.auction.AuctionHouseService;
import com.blackgrid.aetherreachcore.auction.AuctionListing;
...
import com.blackgrid.aetherreachcore.shop.ShopListing;
import com.blackgrid.aetherreachcore.shop.ShopService;
...
public class AetherreachCommands {
                                            ...
                                            .append(Component.literal("Join the Discord")
                                                    .withStyle(style -> style
                                                            ...
                                                            .withClickEvent(new ClickEvent.OpenUrl(
                                                                    URI.create("https://discord.gg/pMfEksZ4Xk"))))),
                                    false
                            );
                            return 1;
                        })
        ...
        dispatcher.register(
                Commands.literal("ah")
                        ...
                        .then(Commands.literal("gui")
                                .executes(ctx -> {
                                    ctx.getSource().sendSuccess(
                                            () -> veilMsg("The Exchange interface is still stabilizing. Use /ah list for now."),
                                            false
                                    );
                                    return 1;
                                }))
                        ...
                        .then(Commands.literal("shop")
                                .then(Commands.literal("reroll")
                                        .executes(ctx -> {
                                            ...
                                            ctx.getSource().sendSuccess(
                                                    () -> adminMsg("Veil Imports rerolled. Active stock: " + listings.size()),
                                                    true
                                            );
                                            return 1;
                                        })))
    ...
    private static int sendShop(CommandSourceStack source) {
        ...
        source.sendSuccess(
                () -> veilMsg("Veil Imports - Current Rotation"),
                false
        );
    ...
    private static int sendAuctionList(CommandSourceStack source, int page) {
        ...
        source.sendSuccess(
                () -> veilMsg("The Exchange - Page " + page),
                false
        );
    ...
    private static MutableComponent veilMsg(String text) {
        return Component.literal("[The Veil] ")
                .withStyle(ChatFormatting.LIGHT_PURPLE)
